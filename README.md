...
1. **Where to register your company**. There's 3 separate ways for registering a company.
...
1. **Key registration documents**: A company is registered by filing the following:
    ...
    - TOC/ ROC
    - Optional: 
        - "Parassocial" or Shareholders Agreement (SHA): A private agreement regulating the internal management of the company in detail, including for example the salary of founders, board meetings and procedures, conditions for future investment rounds and decisions and more.
1. **Pacto Social**
    1. **Type, Name and Address of the company.**
        1. The organization type.
            ...
            - "Sociedade por Quotas": the typical Private Limited company, ending in name "Lda" or "Limitada". The minimum capital to start one is 1€. There's a minimum 1 partner. If you're opening a personal company with just that 1 shareholder, it's typically this type of company and then it's called a "Unipessoal Lda" or "Unipessoal Limitada" or "Unip Lda". The shares of these companies are called "quotas", which are very similar in nature to shares.
        ...
        2. Name:
            ...
            - You can also pick the name yourself. There's 2 ways of doing this. Non-urgent: can take up to 15 days for an answer, and the answer can be "no", if it collides with another firms name, after which you need to start over the 15-day period. You can do a test of similarity online. You can also appeal a negative decision. It costs 75€ as of 2022-11-23. Urgent: You get an answer within 1 business day. It costs 150€ as of 2022-11-23.
    ...
    4. **Capital and Capital per partner.** 
        1. The initial capital with which you will start the company. You can deposit the capital when you get an account or even make a plan of committing that capital along the time, even across fiscal years.
    ...
    5. **Management governance**. 
        - The rules for the people who can take executive decisions in the name of the company, meant as who can establish contracts and liabilities on the company's behalf, potentially with amounts etc. These people are the General Managers.
    7. **Appointment of General Managers**.
        - The Appoint Manager or Managers who will apply the governance, which are called "Gerente(s)" in Ldas and "Administrador(es)" in SA. They can be one or several people. They can be shareholders or not. The group of them is called the "Gerencia" (General Management) in Lds and "Administração" (Administration).
