...
1. **Pacto Social**
    ...
    5. **Management governance**. This specifies who can take executive decisions, meant as who can establish contracts and liabilities on the company's behalf. These people are the General Managers.
    6. **Appointment of General Managers**. Appoint Manager or Managers who will apply the governance, which are "Gerente(s)" in Ldas abd "Administrador(es)" in SA. They can be one or several people. They can be shareholders or not.
- Alongside the Pacto Social you will also file:
    1. **Code of Economic Activity ("CAE")** "Código de Actividade Económica". A code which identifies your economic area. There's a main CAE and sub-codes which you can pick. This is quite important as these codes will define accounting rules, what can be expensed and not, etc.
    2. **TOC ROC** ⚠️
    3.  
